...
public class SimpleExample {
    ...
    public static void main(String[] args) {
        ...
        //  spark.port(5678); <- Uncomment this if you want spark to listen on a port different than 4567
...
public class FilterExample {
    ...
    public static void main(String[] args) {
        ...
        spark.before("/hello", (request, response) -> response.header("Foo", "Set by second before filter"));
...
public class JsonAcceptTypeExample {
    ...
    public static void main(String args[]) {
        ...
        spark.get("/hello", "application/json", (request, response) -> "{\"message\": \"Hello World\"}");
    }
} 
```
---------------------------------
